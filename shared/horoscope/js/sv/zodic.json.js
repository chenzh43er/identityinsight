const dataPage = {
  "Aries": {
    ...
    "monthly": {
      ...
      "article_html": "`\n<h3>Allmän:.</h3><p>Ditt självförtroende är högt, vilket gör detta till en utmärkt månad för personlig utveckling. Ta ledningen för ett projekt som du brinner för..</p><h3>Kärlek:.</h3>If you're in a relationship, try to find new ways to show your affection. Single Aries may stumble upon a romantic interest who challenges their intellect.<p></p><h3>Arbete:.</h3><p>Ditt hårda arbete kommer sannolikt att bli erkänd, men låt inte framgången gå dig åt huvudet. Var ödmjuk och fortsätt anstränga dig..</p><h3>Pengar:.</h3><p>Du kanske lockas av lyxvaror, men det är en bättre tid att spara till något vettigt. Finansiell disciplin nu kommer att löna sig senare..</p> `",
      "image_src": "/horoscope/img/aries.svg",
    ...
    "career": {
      ...
      "image_src": "/horoscope/img/aries.svg",
      "desc": "`<p>Väduren har positiv ambition, handling och beslutsamhet. De är bra på att bryta ny mark. Väduren kan vara väldigt impulsiv när det kommer till personlig prestige och kommer desperat att söka social status. Väduren kommer att sträva efter att tävla med andra, ivriga att vinna tävlingen och skaffa sig ett rykte om professionell excellens. Väduren kan vara karriärblazers..</p>`",
      "name": "Väduren."
    },
    "sex": {
  ...
  "Gemini": {
    ...
    "career": {
      ...
      "article_html": "`\n<p>Tvillingarna är bra för hjärnan och kommunikationen. Detta tillfredsställer Tvillingarnas analytiska och kritiska törst efter författare, journalister och kommunikatörer. Tvillingarna älskar att skvallra om sina liv. De har stark förmåga att anpassa sig till miljön och interpersonell kommunikationsförmåga. Tvillingarna är också kvicktänkta och har ett sinne för humor..</p> `",
      "image_src": "/horoscope/img/gemini.svg",
  ...
  "Leo": {
    ...
    "yearly": {
      ...
      "article_html": "`\n<h3>Allmän.</h3><p>Leomedlemmar kan förvänta sig ett år sprudlande med potentiella och personliga prestationer. Din naturliga karisma kommer att locka till sig gynnsamma omständigheter, men att förbli ödmjuk är nyckeln till att få ut det mesta av dem. Utmaningar är oundvikliga, men de kommer att fungera som en plattform för tillväxt, vilket driver dig att visa upp dina ledaregenskaper. Kom ihåg att dela rampljuset; det är din generositet som kommer att älska dig för andra och ge sann tillfredsställelse..</p><h3>Kärlek.</h3><p>Romance for Leos i år handlar om passion och fördjupad intimitet. Om du är i ett förhållande, planera storslagna gester och små vänliga handlingar för att hålla lågan vid liv. Ensamstående leomedlemmar kommer att upptäcka att deras magnetiska lockelse drar beundrare, men söker en partner som värderar ditt hjärta lika mycket som din styrka. Kommunikationen bör vara hjärtlig och dramatisk; trots allt är du tecknet på stora kärlekshistorier..</p><h3>Arbete.</h3><p>På den professionella fronten kommer leomedlemmar att upptäcka att deras ambition och drivkraft kan leda till betydande prestationer. Det är en tid att ta ledningen i projekt och hävda dina idéer med tillförsikt. Nätverk kommer att löna sig, så gå på evenemang och ta kontakt med influencers inom ditt område. Var dock uppmärksam på lagarbete; dina kollegors stöd är avgörande för långsiktig framgång..</p><h3>Pengar.</h3><p>Ekonomiskt är det här ett år att lysa genom att fatta djärva men kalkylerade beslut. Dina instinkter kommer att vara skarpa, så lita på dem när du utforskar nya investeringsmöjligheter. Undvik dock extravagans; se till att du har en solid sparplan kommer att ge stabiliteten för att njuta av din välförtjänta lyx. Generositet är en ädel egenskap, men håll en balans för att säkra din ekonomiska framtid.</p> `",
      "image_src": "/horoscope/img/leo.svg",
      "desc": "`<h3>Allmän.</h3><p>Leomedlemmar kan förvänta sig ett år sprudlande med potentiella och personliga prestationer. Din naturliga karisma kommer att locka till sig gynnsamma omständigheter, men att förbli ödmjuk är nyckeln till att få ut det mesta av dem. Utmaningar är oundvikliga, men de kommer att fungera som en plattform för tillväxt, vilket driver dig att visa upp dina ledaregenskaper. Kom ihåg att dela rampljuset; det är din generositet som kommer att älska dig för andra och ge sann tillfredsställelse..</p><h3>Kärlek.</h3><p>Romance for Leos i år handlar om passion och fördjupad intimitet. Om du är i ett förhållande, planera storslagna gester och små vänliga handlingar för att hålla lågan vid liv. Ensamstående leomedlemmar kommer att upptäcka att deras magnetiska lockelse drar beundrare, men söker en partner som värderar ditt hjärta lika mycket som din styrka. Kommunikationen bör vara hjärtlig och dramatisk; trots allt är du tecknet på stora kärlekshistorier..</p><h3>Arbete.</h3><p>På den professionella fronten kommer leomedlemmar att upptäcka att deras ambition och drivkraft kan leda till betydande prestationer. Det är en tid att ta ledningen i projekt och hävda dina idéer med tillförsikt. Nätverk kommer att löna sig, så gå på evenemang och ta kontakt med influencers inom ditt område. Var dock uppmärksam på lagarbete; dina kollegors stöd är avgörande för långsiktig framgång..</p><h3>Pengar.</h3><p>Ekonomiskt är det här ett år att lysa genom att fatta djärva men kalkylerade beslut. Dina instinkter kommer att vara skarpa, så lita på dem när du utforskar nya investeringsmöjligheter. Undvik dock extravagans; se till att du har en solid sparplan kommer att ge stabiliteten för att njuta av din välförtjänta lyx. Generositet är en ädel egenskap, men håll en balans för att säkra din ekonomiska framtid.</p>`",
      "name": "Leo."
    },
    "love": {
  ...
  "Pisces": {
    "daily": {
      ...
      "article_html": "`\n<h3>FÖRMÅDESRANKNING: Nr 3.</h3>\n<p>Försoning är bättre än gräl. Försök att uttrycka dina tankar med lugn och respekt..</p>\n<h3>Allmän:.</h3><p>Idag handlar det om att hitta balans mellan dina drömmar och verklighet. Ta tid för båda..</p><h3>Kärlek:.</h3><p>Kompromisser kommer att stärka din relation. För singlar, förlora dig inte i fantasier; håll dig jordad..</p><h3>Arbete:.</h3><p>Ditt engagemang för din vision är beundransvärt, men var realistisk när det gäller tidslinjer och mål.</p><h3>Pengar:.</h3><p>Dröm stort när det kommer till din ekonomiska framtid, men skapa också en praktisk plan för att nå dit..</p> `",
