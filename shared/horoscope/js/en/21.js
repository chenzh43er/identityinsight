const dataPage = {
    ...
    "daily": {
        "section_title": "Gemini Daily Horoscope",
            ...
            "article_html": "\n<h3>FORTUNE RANKING: No.1</h3>\n<p>Inspiration promotes your work. You may finally see the progress you want.</p>\n<h3>General:</h3><p>Flexibility will be your best asset today as plans may change unexpectedly. Go with the flow!</p><h3>Love:</h3><p>A playful banter with your partner will keep the relationship lively. For singles, your charm is particularly potent today.</p><h3>Work:</h3><p>Collaborative projects will benefit from your innovative ideas. Don't hold back in brainstorming sessions.</p><h3>Money:</h3><p>It might be time to rethink your budget—look for ways to cut unnecessary expenses.</p> ",
    ...
    "daily": {
        "section_title": "Cancer Daily Horoscope",
            ...
            "article_html": "\n<h3>FORTUNE RANKING: No.4</h3>\n<p>You may unexpectedly find what you have lost, and recall a beautiful memory.</p>\n<h3>General:</h3><p>A calm and peaceful day is ahead. Use this tranquility to recharge your emotional batteries.</p><h3>Love:</h3><p>Small acts of kindness will mean a lot to your partner. For singles, self-love is as important as romantic love.</p><h3>Work:</h3><p>A steady pace will keep you productive without causing stress. Prioritize your tasks.</p><h3>Money:</h3><p>Avoid any impulsive financial decisions. Stick to your budget and save for a rainy day.</p> ",
            "image_src": "/horoscope/img/cancer.svg",
            "desc": "<h3>General:</h3><p>A calm and peaceful day is ahead. Use this tranquility to recharge your emotional batteries.</p><h3>Love:</h3><p>Small acts of kindness will mean a lot to your partner. For singles, self-love is as important as romantic love.</p><h3>Work:</h3><p>A steady pace will keep you productive without causing stress. Prioritize your tasks.</p><h3>Money:</h3><p>Avoid any impulsive financial decisions. Stick to your budget and save for a rainy day.</p>"
    },
    "weekly": {
    ...
    "daily": {
        "section_title": "Virgo Daily Horoscope",
            ...
            "article_html": "\n<h3>FORTUNE RANKING: No.9</h3>\n<p>Through communication, the conflict troubling you may get a solution.</p>\n<h3>General:</h3><p>Your practicality is an asset, but don't forget to dream big. Balance is key.</p><h3>Love:</h3><p>Share your dreams with your partner to build a deeper connection. Single Virgos should not ignore their romantic ideals.</p><h3>Work:</h3><p>Aim high but keep your goals realistic. Your ambition is noticed by superiors.</p><h3>Money:</h3><p>Long-term investments are favored today. Think about the future.</p> ",
            "image_src": "/horoscope/img/virgo.svg",
            "desc": "<h3>General:</h3><p>Your practicality is an asset, but don't forget to dream big. Balance is key.</p><h3>Love:</h3><p>Share your dreams with your partner to build a deeper connection. Single Virgos should not ignore their romantic ideals.</p><h3>Work:</h3><p>Aim high but keep your goals realistic. Your ambition is noticed by superiors.</p><h3>Money:</h3><p>Long-term investments are favored today. Think about the future.</p>"
    },
    "weekly": {
    ...
    "daily": {
        "section_title": "Libra Daily Horoscope",
            ...
            "article_html": "\n<h3>FORTUNE RANKING: No.11</h3>\n<p>An inspiring dream is waiting for you. You can enjoy a fair and sweet sleep.</p>\n<h3>General:</h3><p>Your cooperative nature is a boon to group dynamics today. Engage with your community.</p><h3>Love:</h3><p>Compromise is key in maintaining harmony with your significant other. Singles should consider what they're willing to compromise in a relationship.</p><h3>Work:</h3><p>Collaboration brings success. Look for opportunities to partner with colleagues.</p><h3>Money:</h3><p>Joint financial ventures may be advantageous, but ensure terms are clear to all parties.</p> ",
            "image_src": "/horoscope/img/libra.svg",
            "desc": "<h3>General:</h3><p>Your cooperative nature is a boon to group dynamics today. Engage with your community.</p><h3>Love:</h3><p>Compromise is key in maintaining harmony with your significant other. Singles should consider what they're willing to compromise in a relationship.</p><h3>Work:</h3><p>Collaboration brings success. Look for opportunities to partner with colleagues.</p><h3>Money:</h3><p>Joint financial ventures may be advantageous, but ensure terms are clear to all parties.</p>"
    },
    "weekly": {
    ...
    "daily": {
        "section_title": "Scorpio Daily Horoscope",
            ...
            "article_html": "\n<h3>FORTUNE RANKING: No.2</h3>\n<p>Pay attention to scenery along the way you tend to overlook, you may find some surprises.</p>\n<h3>General:</h3><p>Your natural charisma shines today. Use this to your advantage in social situations.</p><h3>Love:</h3><p>Romance takes a playful turn. Enjoy light-hearted moments with your partner or, if single, flirtation could be reciprocated with interest.</p><h3>Work:</h3><p>Your charm can help you network effectively. Make new connections.</p><h3>Money:</h3><p>You might find financial opportunities through your social circle. Keep an ear out for tips.</p> ",
            "image_src": "/horoscope/img/scorpio.svg",
            "desc": "<h3>General:</h3><p>Your natural charisma shines today. Use this to your advantage in social situations.</p><h3>Love:</h3><p>Romance takes a playful turn. Enjoy light-hearted moments with your partner or, if single, flirtation could be reciprocated with interest.</p><h3>Work:</h3><p>Your charm can help you network effectively. Make new connections.</p><h3>Money:</h3><p>You might find financial opportunities through your social circle. Keep an ear out for tips.</p>"
    },
    "weekly": {
    ...
    "daily": {
        "section_title": "Capricorn Daily Horoscope",
            ...
            "article_html": "\n<h3>FORTUNE RANKING: No.12</h3>\n<p>Understanding others may help you be understood too. Ideas can be conveyed with sincerity. </p>\n<h3>General:</h3><p>Today, your ambition is on full display. Use this energy to set lofty goals for yourself.</p><h3>Love:</h3><p>Aspire to create new goals with your partner. If single, you may be attracted to someone who shares your ambition.</p><h3>Work:</h3><p>Aim high in your career endeavors. Your ambition will impress your superiors and may lead to opportunities.</p><h3>Money:</h3><p>Set financial targets that challenge you to grow your wealth. Your ambition will help you find ways to achieve them.</p> ",
            "image_src": "/horoscope/img/capricorn.svg",
            "desc": "<h3>General:</h3><p>Today, your ambition is on full display. Use this energy to set lofty goals for yourself.</p><h3>Love:</h3><p>Aspire to create new goals with your partner. If single, you may be attracted to someone who shares your ambition.</p><h3>Work:</h3><p>Aim high in your career endeavors. Your ambition will impress your superiors and may lead to opportunities.</p><h3>Money:</h3><p>Set financial targets that challenge you to grow your wealth. Your ambition will help you find ways to achieve them.</p>"
    },
    "weekly": {
    ...
    "daily": {
        "section_title": "Pisces Daily Horoscope",
            ...
            "article_html": "\n<h3>FORTUNE RANKING: No.3</h3>\n<p>Reconciliation is better than quarrels. Try expressing your thoughts with calm and respect.</p>\n<h3>General:</h3><p>Today is about finding balance between your dreams and reality. Make time for both.</p><h3>Love:</h3><p>Compromise will strengthen your relationship. For singles, don't lose yourself in fantasies; stay grounded.</p><h3>Work:</h3><p>Your dedication to your vision is admirable, but be realistic about timelines and goals.</p><h3>Money:</h3><p>Dream big when it comes to your financial future, but also create a practical plan to get there.</p> ",
            "image_src": "/horoscope/img/pisces.svg",
            "desc": "<h3>General:</h3><p>Today is about finding balance between your dreams and reality. Make time for both.</p><h3>Love:</h3><p>Compromise will strengthen your relationship. For singles, don't lose yourself in fantasies; stay grounded.</p><h3>Work:</h3><p>Your dedication to your vision is admirable, but be realistic about timelines and goals.</p><h3>Money:</h3><p>Dream big when it comes to your financial future, but also create a practical plan to get there.</p>"
    },
    "weekly": {
