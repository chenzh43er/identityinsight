const dataPage = {
  ...
  "Virgo": {
    "daily": {
      ...
      "article_html": "\n<h3>VERMÖGENSRANGLISTE: Nr. 9.</h3>\n<p>Durch Kommunikation kann der Konflikt, der Sie beschäftigt, eine Lösung finden.</p>\n<h3>Allgemein:.</h3><p>Ihre Praktikabilität ist von Vorteil, aber vergessen Sie nicht, große Träume zu haben. Ausgewogenheit ist der Schlüssel..</p><h3>Liebe:.</h3><p>Teilen Sie Ihre Träume mit Ihrem Partner, um eine tiefere Verbindung aufzubauen. Alleinstehende Jungfrauen sollten ihre romantischen Ideale nicht ignorieren.</p><h3>Arbeiten:.</h3><p>Setzen Sie sich hohe Ziele, aber bleiben Sie realistisch. Ihr Ehrgeiz wird von Vorgesetzten wahrgenommen.</p><h3>Geld:.</h3><p>Langfristige Investitionen werden heute bevorzugt. Denken Sie an die Zukunft..</p> ",
  ...
  "Libra": {
    "daily": {
      ...
      "article_html": "\n<h3>VERMÖGENSRANGLISTE: Nr. 11.</h3>\n<p>Ein inspirierender Traum wartet auf Sie. Sie können einen angenehmen und angenehmen Schlaf genießen.</p>\n<h3>Allgemein:.</h3><p>Ihre kooperative Art ist heute ein Segen für die Gruppendynamik. Engagieren Sie sich mit Ihrer Community.</p><h3>Liebe:.</h3><p>Kompromisse sind der Schlüssel zur Aufrechterhaltung der Harmonie mit Ihrem Lebensgefährten. Singles sollten sich überlegen, auf welche Kompromisse sie in einer Beziehung bereit sind.</p><h3>Arbeiten:.</h3><p>Zusammenarbeit bringt Erfolg. Suchen Sie nach Möglichkeiten, mit Kollegen zusammenzuarbeiten.</p><h3>Geld:.</h3><p>Joint-Finance-Ventures können von Vorteil sein, aber stellen Sie sicher, dass die Bedingungen für alle Parteien klar sind.</p> ",
