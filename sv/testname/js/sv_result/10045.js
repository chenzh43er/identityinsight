const results = {
    1: {
        ...
        "resultTitle": "Romantikern från Gryffindor",
        "description": "Du älskar med passion och mod. När du blir kär är du inte rädd för någonting. Du vill uppleva en berättelse som är värd en magisk berättelse.\n" +
            ...
            "Avantage\n" +
            "Ton cœur brûle d’un feu sincère. Tu inspires les autres à croire en l’amour véritable.\n" +
            "\n" +
            "Harmonie magique\n" +
            "\n" +
    ...
    2: {
        "title": "Vilken Hogwarts-student är du kär?",
        "resultTitle": "Ravenclaw Dreamer",
        "description": "Din kärlek är djup, omtänksam och poetisk. Du gillar inte bullriga passioner, utan själsförbindelser, konversationer som varar till gryningen.\n" +
            "Façons de s'entendre\n" +
            "Tu séduis par ton esprit et ta sensibilité. Tu observes, comprends, et donnes un amour calme mais sincère.\n" +
            "Avantage\n" +
            "Ton intelligence émotionnelle et ton intuition. Tu lis dans le cœur des gens comme dans un vieux grimoire.\n" +
            "\n" +
            "Harmonie magique\n" +
            "\n" +
    ...
    3: {
        "title": "Vilken Hogwarts-student är du kär?",
        "resultTitle": "Slytherinstrategen",
        "description": "Du älskar på ett mystiskt och intensivt sätt. Du analyserar innan du agerar, men när du väl erövrad blir din kärlek orubblig.\n" +
            "Façons de s'entendre\n" +
            ...
            "Avantage\n" +
            "Ton dévouement absolu une fois que tu fais confiance. Tu n’aimes pas à moitié, tu aimes pour toujours.\n" +
            "\n" +
            "Harmonie magique\n" +
            "\n" +
    ...
    4: {
        "title": "Vilken Hogwarts-student är du kär?",
        "resultTitle": "Hufflepuffs lojala hjärta",
        "description": "Du tror på vänlighet, tålamod och de små gesterna som får kärleken att växa. Du gillar inte spel, bara uppriktighet.\n" +
            "Façons de s'entendre\n" +
            ...
            "Avantage\n" +
            "Ta fidélité et ton optimisme. Tu fais sentir à ton partenaire qu’il est chez lui à tes côtés.\n" +
            "\n" +
            "Harmonie magique\n" +
            "\n" +
